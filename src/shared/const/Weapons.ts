...
export const WEAPONS: Record<string, WeaponData> = {
  ...
  кинджал: {
    ...
    damage: '1d4',
    damageType: 'колюча',
    properties: ['фехтувальна', 'легка', 'метальна'],
    finesse: true,
    thrown: true,
  },
  ...
  спис: {
    ...
    versatileDamage: '1d8',
    damageType: 'колюча',
    properties: ['метальна', 'універсальна'],
    thrown: true,
  },
  'легкий арбалет': {
    name: 'Легкий арбалет',
    ...
    damage: '1d8',
    damageType: 'колюча',
    properties: ['боєприпаси', 'перезарядка', 'дворучна'],
    ranged: true,
  },
  'ручний арбалет': {
    name: 'Ручний арбалет',
    ...
    damage: '1d6',
    damageType: 'колюча',
    properties: ['боєприпаси', 'перезарядка', 'легка'],
    ranged: true,
  },
  'довгий лук': {
    name: 'Довгий лук',
    ...
    damage: '1d8',
    damageType: 'колюча',
    properties: ['боєприпаси', 'дворучна'],
    ranged: true,
  },
  'короткий лук': {
    name: 'Короткий лук',
