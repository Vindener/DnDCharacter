...
Output: write to `/home/vindener/Files/Projects/DnDCharacter/.ua/intermediate/batch-31.json` (single-file mode) OR `batch-31-part-<k>.json` (split mode, per Step B of your output protocol).

Pre-resolved import data for this batch (use directly — do NOT re-resolve imports from source):
```json
{
  "src/test/mocks/react-native-firebase-crashlytics.ts": [],
  "src/test/mocks/react-native.tsx": [],
  "src/types/DM.ts": [],
  "src/types/SourceMetadata.ts": [],
  "vitest.config.ts": [],
...
1. `src/test/mocks/react-native-firebase-crashlytics.ts` (11 lines, language: `typescript`, fileCategory: `code`)
2. `src/test/mocks/react-native.tsx` (75 lines, language: `typescript`, fileCategory: `code`)
3. `src/types/DM.ts` (17 lines, language: `typescript`, fileCategory: `code`)
4. `src/types/SourceMetadata.ts` (1 lines, language: `typescript`, fileCategory: `code`)
5. `vitest.config.ts` (21 lines, language: `typescript`, fileCategory: `code`)
6. `vitest.rules.config.ts` (11 lines, language: `typescript`, fileCategory: `code`)
