...
Output: write to `/home/vindener/Files/Projects/DnDCharacter/.ua/intermediate/batch-20.json` (single-file mode) OR `batch-20-part-<k>.json` (split mode, per Step B of your output protocol).
...
1. `android/app/src/main/res/values/colors.xml` (6 lines, language: `xml`, fileCategory: `config`)
2. `android/app/src/main/res/values/strings.xml` (5 lines, language: `xml`, fileCategory: `config`)
3. `android/app/src/main/res/values/styles.xml` (12 lines, language: `xml`, fileCategory: `config`)
