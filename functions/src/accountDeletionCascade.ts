// Keep this file's logic in sync with src/services/accountDeletionCascade.ts —
// this package cannot import from the app's src/ (separate Node runtime/deploy unit).
