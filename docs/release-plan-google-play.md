...
| # | Задача | Файли | DoD |
| --- | --- | --- | --- |
| R1-1 | ⏳ **На розгляді Google (2026-08-12).** Play Console: реєстрація, верифікація, тип акаунта, створення застосунку — ✅. Перший AAB в Internal testing — ✅. Випуск `1.0.0 (4) — закритий тест` (15 змін: AAB, країни, тестувальники, декларації контенту) надіслано на перевірку — стан **«Перевіряється»** (`submission-activity/1`). **Старт 14-денного відліку відбудеться після схвалення Google**, коли реальні тестувальники приймуть запрошення — це ще попереду | — | Заявку подано; відлік 14 днів стартує **після** апруву й приєднання тестувальників, не з моменту подання — див. `docs/release-blockers.md` |
