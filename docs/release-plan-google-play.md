...
**Статус (2026-08-28):** заявка на production access подана 2026-08-27, на розгляді Google (типово до 7 днів, орієнтовно до 2026-09-03) — див. `docs/release-blockers.md` п.1. Поки триває розгляд, R5-1 (регресійний чекліст) і R5-2 (фінальний AAB) можна готувати паралельно.
